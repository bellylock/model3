$(function(){
	// var index = $(".btn-toggle").attr("index");
	// $(".moreShop").hide();
	// $($(".btn-toggle")[index]).on("click",function(){
	// 	console.log(index)
	// 	$($(".moreShop")[index]).slideToggle();
	// }); 
	$(".service>ul>li").on("click",function(){
		var index = $(this).index(); 
		if ($($(".service>ul>li")[index]).hasClass("active")) {
			$($(".service>ul>li")[index]).removeClass("active");
		}else{
			$($(".service>ul>li")[index]).addClass("active");
		}
	});
	var provinceList = [
                    {name:'北京', cityList:[
...
$(function(){
    var provinceOption = "<option>请选择省</option>";
    for(var i = 0 ; i < provinceList.length ; i++){
        provinceOption += "<option>"+ provinceList[i].name +"</option>"
    }
    $("#province").html(provinceOption);
    $("#province").on("change",function(){
        var cityIndex = -1;
        for(var i = 0 ; i < provinceList.length ; i++){
            if(provinceList[i].name == this.value){
                cityIndex = i;
                break;
            }
        }
        if(cityIndex != -1){
            ...
            for(var i = 0 ; i < provinceList[cityIndex].cityList.length ; i++){
                option += "<option>"+  provinceList[cityIndex].cityList[i].name +"</option>";
            }
            $("#city").html(option);
            $("#city").on("change",function(){
                ...
                if(townIndex != -1){
                    var townOption = "<option>请选择城区（县）</option>";

                    for(var i = 0 ; i < citys[townIndex].areaList.length ; i++){
                        townOption += "<option>"+  citys[townIndex].areaList[i] +"</option>"
                    }
     ...
     var flag = true;
     $(".public .brand .button").on("click",function(){
          $(this).toggleClass("active");
          if (flag == false) {
               $(".public .brandClassify li").removeClass("active"); 
               $($(".public .brandClassify li")[0]).addClass("active"); 
          }
          flag = !flag;
     });
     $(".public .brandClassify li").on("click",function(){
          if(flag){
               $(".public .brandClassify li").removeClass("active"); 
      ...
      $(".public .number .button").on("click",function(){
          $(this).toggleClass("active");
          if (flag == false) {
               $(".public .amount li").removeClass("active"); 
               $($(".public .amount li")[0]).addClass("active"); 
          }
          flag = !flag;
     });
     $(".public .amount li").on("click",function(){
          if(flag){
               $(".public .amount li").removeClass("active"); 
               $(this).addClass("active"); 
          }else{
     ...
     $(".public .fabric .button").on("click",function(){
          $(this).toggleClass("active");
          if (flag == false) {
               $(".public .cotton li").removeClass("active"); 
               $($(".public .cotton li")[0]).addClass("active"); 
          }
          flag = !flag;
     });
     $(".public .cotton li").on("click",function(){
          if(flag){
               $(".public .cotton li").removeClass("active"); 
               $(this).addClass("active"); 
          }else{
      ...
      $(".public .style .button").on("click",function(){
          $(this).toggleClass("active");
          if (flag == false) {
               $(".public .manner li").removeClass("active"); 
               $($(".public .manner li")[0]).addClass("active"); 
          }
          flag = !flag;
     });
     $(".public .manner li").on("click",function(){
          if(flag){
               $(".public .manner li").removeClass("active"); 
               $(this).addClass("active"); 
          }else{
     ...
     $(".public .size .button").on("click",function(){
          $(this).toggleClass("active");
          if (flag == false) {
               $(".public .dimension li").removeClass("active"); 
               $($(".public .dimension li")[0]).addClass("active"); 
          }
          flag = !flag;
     });
     $(".public .dimension li").on("click",function(){
          if(flag){
               $(".public .dimension li").removeClass("active"); 
               $(this).addClass("active"); 
          }else{
